...
class CheckoutView extends ConsumerStatefulWidget {
  ...
  final bool showAwaitingConfirmation;
  final bool enableScroll; // Nova propriedade para controlar o scroll

  const CheckoutView({
    super.key,
    this.showAppBar = true,
    this.showAwaitingConfirmation = true,
    this.enableScroll =
        true, // Por padrão, scroll habilitado (tela independente)
  });
...
class _CheckoutViewState extends ConsumerState<CheckoutView> {
  ...
  Widget build(BuildContext context) {
    ...
    // Conteúdo principal do CheckoutView
    Widget content = Column(
      mainAxisSize: MainAxisSize.min,
      children: <Widget>[
        if (widget.showAwaitingConfirmation)
          Center(
            child: Text(
                    ...
                    child: Container(
                      ...
                      child: ListTile(
                        trailing: AnimatedSwitcher(
                          ...
                          child:
                              order?.status == BusinessOrderStatus.accepted ||
                        ...
                        subtitle: Text(
                          ref
                              ...
                              .getStatusTranslation(
                                  order?.status.name ?? 'waitingConfirmation'),
                        ),
                      ),
                    ),
                  );
    ...
    // Decide se usa SingleChildScrollView ou apenas o Column com base em enableScroll
    return Scaffold(
