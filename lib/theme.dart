...
class MaterialTheme {
  ...
  static MaterialScheme lightScheme() {
    return const MaterialScheme(
      ...
      secondaryFixedDim: Color(0xffc2cd7d),
  ...
  static MaterialScheme lightMediumContrastScheme() {
    return const MaterialScheme(
      ...
      onSecondary: Color(0xffffffff),
      secondaryContainer: Color(0xff707a33),
      ...
      secondaryFixed: Color(0xff707a33),
  ...
  static MaterialScheme lightHighContrastScheme() {
    return const MaterialScheme(
      ...
      surfaceTint: Color(0xff336940),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xff144d27),
      onPrimaryContainer: Color(0xffffffff),
  ...
  static MaterialScheme darkHighContrastScheme() {
    return const MaterialScheme(
      ...
      primaryContainer: Color(0xff9ed9a6),
      onPrimaryContainer: Color(0xff000000),
      secondary: Color(0xfff9ffcc),
      onSecondary: Color(0xff000000),
      secondaryContainer: Color(0xffc6d280),
      onSecondaryContainer: Color(0xff000000),
      tertiary: Color(0xffeefff3),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xff91dab6),
      onTertiaryContainer: Color(0xff000000),
      ...
      primaryFixedDim: Color(0xff9ed9a6),
      onPrimaryFixedVariant: Color(0xff001b08),
      secondaryFixed: Color(0xffe2ee9a),
      onSecondaryFixed: Color(0xff000000),
      secondaryFixedDim: Color(0xffc6d280),
      onSecondaryFixedVariant: Color(0xff141800),
      tertiaryFixed: Color(0xffadf6d1),
      onTertiaryFixed: Color(0xff000000),
      tertiaryFixedDim: Color(0xff91dab6),
